...
async def test_undetected_crawler():
    print("test starting...")
    session_manager = SessionsManager()
    await session_manager.init_undetected_crawler("https://www.facebook.com/marketplace/montreal/propertyrentals?exact=false&latitude=45.50889&longitude=-73.63167&radius=7&locale=fr_CA")
