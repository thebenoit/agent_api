...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      {/* Header */}
      <div className="border-b bg-white px-6 sm:px-8 lg:px-12 py-4 sm:py-6">
        <div className="w-full max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-semibold text-black text-sm sm:text-base">Moveout</span>
          </div>
          <div className="flex gap-3 sm:gap-4">
            <button className="px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              Se connecter
            </button>
            <button className="px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-black text-white rounded-lg hover:bg-gray-800 transition-colors">
              Commencer
            </button>
          </div>
        </div>
